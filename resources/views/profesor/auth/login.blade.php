    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('profesor.login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                @if (Route::has('profesor.password.request'))
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('profesor.password.request') }}">
