                        ...
                        <div class="card-body">
                            <div class="grid grid-cols-2"></div>
                                <div class="2xl:flex 2xl:items-center mb-6">
                                    ...
                                    <div class="2xl:w-2/3">
                                      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" value="{{$carrerasinscripto->first()->carrera->numero_plan}}" id="carreranumeroplan" name="carreranumeroplan" disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="2xl:flex 2xl:items-center mb-6">
                                    ...
                                    <div class="2xl:w-2/3">
                                      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" value="{{$carrerasinscripto->first()->carrera->departamento}}"id="carreradepartamento" name="carreradepartamento" disabled>
                                    </div>
                                  </div>
                            </div>
                        </div>
